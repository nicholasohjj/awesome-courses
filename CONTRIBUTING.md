...
Have a few courses in mind that you think are awesome and would fit in this list? Feel free to send a [pull request](https://github.com/nicholasohjj/awesome-courses/pulls). However, do note that I'm not keen on adding popular courses (such as MOOCs / MIT OCW) as there are services like [ClassCentral](https://www.class-central.com/) doing a great job of aggregation. This list is ideally for courses which are relatively unknown and make their material (assignments, lectures, exams etc.) available online for free.

**Note:** Courses from ocw.mit.edu will be rejected.
...
- When adding sublinks under a course (such as "Lecture Videos", "Assignments", etc.), only include them if they point to a **different website** than the main course link. Do not add sublinks that point to the same website/domain as the course link, as this is redundant and clutters the list.